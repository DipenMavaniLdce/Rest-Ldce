...
public String toString() {
	return "Student_info [id=" + id + ", father_name=" + father_name + ", mother_name=" + mother_name + ", aadhar="
			+ aadhar + ", dob=" + date_of_birth + ", blood_group=" + blood_group + ", re_add_l1=" + re_add_l1 + ", re_add_l2="
			+ re_add_l2 + ", re_add_city=" + re_add_city + ", re_add_state=" + re_add_state + ", re_add_pincode="
			+ re_add_pin_code + ", re_add_country=" + re_add_country + ", pr_add_l1=" + pr_add_l1 + ", pr_add_l2="
			+ pr_add_l2 + ", pr_add_city=" + pr_add_city + ", pr_add_state=" + pr_add_state + ", pr_add_pincode="
			+ pr_add_pin_code + ", pr_add_country=" + pr_add_country + ", hsc_year=" + hsc_year + ", hsc_pr=" + hsc_pr
			+ ", ssc_year=" + ssc_year + ", ssc_pr=" + ssc_pr + "]";
}


public String getPerment_address() {return this.pr_add_l1;}
}
