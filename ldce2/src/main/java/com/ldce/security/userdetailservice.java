...
public class userdetailservice implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(type.equals("STUDENT")) {
			...
			if(student==null) { System.out.println("ni malojbhbhjb");throw new UsernameNotFoundException("404");}
			...
			if(admin==null) { System.out.println("ni malo");throw new UsernameNotFoundException("404");}
